...
export async function POST(request: Request) {
    try {
        ...
        const { city, temperature, condition, rainChance } = body.weatherData;
        ...
        const userMessage = `
            ...
            City: ${city}, Temperature: ${temperature}°C, Condition: ${condition}, Chance of Rain: ${rainChance}%
        `;
      ...
      if (error instanceof Error) {
          console.error("Error generating weather report:", error.message, error.stack);
