            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:block">
                {!loading && user === null ? (
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger>
                      <div className="rounded-full inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 w-10 hover:bg-accent hover:text-accent-foreground ">
                        <Image
                          width={32}
                          height={32}
