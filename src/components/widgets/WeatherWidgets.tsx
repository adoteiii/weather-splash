...
export default function WeatherWidgets({
  ...
  return (
    <>
      <AirPollution
        data={airQuality.current.air_quality}
      ...
      <Card className="order-4 h-48 xl:order-3">
        ...
        <CardContent className="flex justify-center p-0">
          <Compass speed={data[0].wind_mph} deg={data[0].wind_degree} />
        </CardContent>
      </Card>
      <Card className="order-5 flex h-48 flex-col justify-between">
        ...
        <CardContent>
          ...
          <Progress aria-label="UV Index" value={data[0].uv * 10} />
        </CardContent>
        <CardFooter>
          <p>
            {data[0].uv <= 2
      ...
      <Card className="order-6 flex h-48 flex-col justify-between">
        ...
        <CardContent>
          <ThreeHourPrecip precip_mm={data[0].precip_mm} />
        </CardContent>
        <CardFooter>
          <p>
            {data[0].precip_mm !== undefined
              ? data[0].precip_mm <= 0.2
                ? "Light rain or drizzle. An umbrella may come in handy."
                : data[0].precip_mm <= 2.5
                ? "Moderate rain."
                : "Heavy rain."
              : "Conditions are dry."}
          </p>
      ...
      <Card className="order-10 flex h-48 flex-col justify-between">
        ...
        <CardContent>
          <p>{data[0].pressure_mb} hPa</p>
        </CardContent>
        <CardFooter>
          <p>
            {data[0].pressure_mb < 1000
              ? "Low pressure. Expect changes in the weather."
              : data[0].pressure_mb >= 1000 && data[0].pressure_mb <= 1010
